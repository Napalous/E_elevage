...
class ReunionController extends AbstractController
{
    ...
    public function index(ReunionRepository $reunionRepository): Response
    {
     ...
     /**
     * @Route("/event", name="reunion_index2", methods={"GET"})
     */
    public function index2(ReunionRepository $reunionRepository): Response
    {
        return $this->render('reunion/index2.html.twig', [
            'reunions' => $reunionRepository->findAll(),
        ]);
    }
