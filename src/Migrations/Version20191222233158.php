 ...
 */
final class Version20191222233158 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vente ADD prix INT NOT NULL, CHANGE bovins_id bovins_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vente DROP prix, CHANGE bovins_id bovins_id INT DEFAULT NULL');
    }
}
