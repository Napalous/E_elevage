 ...
 */
final class Version20191206213050 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD active TINYINT(1) NOT NULL, CHANGE roles roles JSON NOT NULL');
