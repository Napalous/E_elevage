 ...
 */
final class Version20191222230522 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE vente (id INT AUTO_INCREMENT NOT NULL, bovins_id INT DEFAULT NULL, create_at DATETIME NOT NULL, INDEX IDX_888A2A4CFB9C6E64 (bovins_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE vente ADD CONSTRAINT FK_888A2A4CFB9C6E64 FOREIGN KEY (bovins_id) REFERENCES bovin (id)');
        ...
        $this->addSql('ALTER TABLE details_commande CHANGE produits_id produits_id INT DEFAULT NULL, CHANGE commande_id commande_id INT DEFAULT NULL');
